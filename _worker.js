...
// UmiCare v5.6.8 – Cloudflare Worker with Static Assets
...
const DEFAULT_SETTINGS = { lastPersonWeight: 66.5, catName: '屋咪', appVersion: '5.6.8' };
...
async function handleApi(request, env, url) {
  ...
  try {
    // PING
    if (path === '/ping') return json({ ok: true, version: '5.6.8', kv: !!KV });
